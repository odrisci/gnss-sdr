    ...
    while(stop_ == false)
        {
            ...
            while( global_gps_acq_assist_queue.try_pop(gps_acq) )
            {
...
void ControlThread::gps_ephemeris_data_collector()
{
    ...
    while(stop_ == false)
        {
            boost::this_thread::sleep(boost::posix_time::milliseconds(100));
            while( global_gps_ephemeris_queue.try_pop(gps_eph) )
            {
...
void ControlThread::galileo_ephemeris_data_collector()
{
    ...
    while(stop_ == false)
        {
            boost::this_thread::sleep(boost::posix_time::milliseconds(100));
            while( global_galileo_ephemeris_queue.try_pop(galileo_eph) )
            {
...
void ControlThread::gps_iono_data_collector()
{
    ...
    while(stop_ == false)
        {
            boost::this_thread::sleep(boost::posix_time::milliseconds(100));
            while( global_gps_iono_queue.try_pop(gps_iono) )
            {
...
void ControlThread::galileo_almanac_data_collector()
{
    ...
    while(stop_ == false)
        {
            boost::this_thread::sleep(boost::posix_time::milliseconds(100));
            while( global_galileo_almanac_queue.try_pop(galileo_almanac) )
            {
...
void ControlThread::galileo_iono_data_collector()
{
    ...
    while(stop_ == false)
        {
            boost::this_thread::sleep(boost::posix_time::milliseconds(100));
            while( global_galileo_iono_queue.try_pop(galileo_iono) )
            {
...
void ControlThread::gps_utc_model_data_collector()
{
    ...
    while(stop_ == false)
        {
            boost::this_thread::sleep(boost::posix_time::milliseconds(100));
            while( global_gps_utc_model_queue.try_pop(gps_utc) )
            {
...
void ControlThread::gps_ref_location_data_collector()
{
    ...
    while(stop_ == false)
        {
            boost::this_thread::sleep(boost::posix_time::milliseconds(100));
            while( global_gps_ref_location_queue.try_pop(gps_ref_location) )
            {
...
void ControlThread::gps_ref_time_data_collector()
{
    ...
    while(stop_ == false)
        {
            boost::this_thread::sleep(boost::posix_time::milliseconds(100));
            while( global_gps_ref_time_queue.try_pop(gps_ref_time) )
            {
...
void ControlThread::galileo_utc_model_data_collector()
{
    ...
    while(stop_ == false)
        {
            boost::this_thread::sleep(boost::posix_time::milliseconds(100));
            while( global_galileo_utc_model_queue.try_pop(galileo_utc) )
            {
